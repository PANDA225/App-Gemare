...
export default function MaintenancePage() {
  ...
  const fetchMaintenances = async () => {
    ...
    try {
      ...
      const fetchedMaintenances = querySnapshot.docs.map((doc) => ({
        id: doc.id,
        ...doc.data(),
      }));
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Calendar
        ...
        theme={{
          arrowColor: "#154F3A",
          monthTextColor: "#154F3A",
          textMonthFontWeight: "bold",
          textMonthFontSize: 28,
          todayBackgroundColor: "#154F3A",
        ...
        maintenances.map((maintenance, index) => (
          <TouchableOpacity
            ...
            style={[
              ...
              selectedMaintenance && selectedMaintenance.id === maintenance.id
                ? styles.selectedItem
                : null,
            ]}
          ...
          >
            ...
            >
              Fecha de inicio: {maintenance.startDate}
            </Text>
            <Text
              style={[
                styles.maintenanceText,
