  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('ViewReportsPage', { area: area })} style={styles.buttonWithLabel}>
      ...
      <FAB.Group
        ...
        fabStyle={styles.fab}
        actions={[
          { icon: 'logout', label: 'Cerrar Sesión', onPress: handleSignOut, color: '#FFFFFF', style: { backgroundColor: 'red' }, labelStyle: styles.fabLabel },
          // Más acciones aquí
        ]}
