...
const ViewReportsPage = () => {
  ...
  useEffect(() => {
    ...
    const reportsQuery = query(reportsCollection, where('area', '==', area));  // Asegúrate de que 'userEmail' es el correo del técnico actual.
  ...
  <Text style={styles.header}>Reportes Enviados</Text>
      ...
      <ScrollView style={styles.reportsContainer}>
        {reports.map((report) => (
          <TouchableHighlight key={report.id} style={styles.reportItem} underlayColor="#DDDDDD" onPress={() => navigation.navigate('ReportDetailsPage', { report })}>
